...
import { PlayCircleIcon, DocumentMagnifyingGlassIcon, QuestionMarkCircleIcon, CogIcon, ArrowRightCircleIcon, PresentationChartLineIcon, ScaleIcon } from '@heroicons/react/24/outline';

const LandingPage: React.FC = () => {
  return (
    <div className="bg-white p-6 sm:p-10 rounded-xl shadow-2xl max-w-5xl mx-auto text-slate-700">
      <header className="text-center mb-10 sm:mb-12">
        <ScaleIcon className="h-20 w-20 sm:h-24 sm:w-24 text-sky-600 mx-auto mb-4" />
